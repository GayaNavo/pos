...
export const SupplierModel = ({
    addSupplierModel, setAddSupplierOpen, name, setName, companyName, setCompanyName, mobile, setMobile, error, handleSupplierSubmit, handleSupplierClear, setError, setResponseMessage, setProgress,}) => {

    const validateAndSubmitSupplier = (e, name, companyName, mobile, setError, setResponseMessage, setProgress, setAddSupplierOpen, handleSupplierClear, handleSupplierSubmit) => {
        e.preventDefault();
        setError('');
        setResponseMessage('');
        setProgress(true);
