...
function CreateBarcodeBody() {
  ...
  const handleProductSelect = (product) => {
    if (product.ptype === "Variation" && product.variationValues) {
      ...
      setSelectedProduct((prevProducts) => [...prevProducts, ...variations]);
    } else {
      setSelectedProduct((prevProducts) => [
        ...prevProducts,
        {
  ...
  useEffect(() => {
    generateBarcode();
  }, [selectedProduct, showCompanyName, showProductName, showPrice, stickerWidth, stickerHeight, barcodesPerRow, companyName]);
                  ...
                  {generatedBarcodeValue
                    ...
                    .map((item, index) => (
                      ...
                      >
                        ...
                        <p className="barcode-code text-center font-semibold text-xs">{item.barcode}</p>
                        {item.productName && (
