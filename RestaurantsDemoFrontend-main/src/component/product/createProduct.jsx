...
function CreateProductBody() {
  ...
  const handleVariationValueChange = (warehouseName, variationType, field, value) => {
    setWarehouseVariationValues(prev => {
      const prevWarehouse = prev[warehouseName] || {};
      const prevVariation = prevWarehouse[variationType] || {};
      ...
      return {
        ...
        [warehouseName]: {
          ...prevWarehouse,
          [variationType]: updatedVariation
        }
      };
    });
  };
  ...
  useEffect(() => {
    ...
    const validateSingleWarehouse = (warehouseName) => {
      ...
      const profitMargin = w.profitMargin;
      if (profitMargin === "" || profitMargin === null || profitMargin === undefined) return false;

      const pm = Number(profitMargin);
      if (Number.isNaN(pm) || pm < 0) return false;
    ...
    const validateVariationWarehouse = (warehouseName) => {
      const variations = warehouseVariationValues[warehouseName];
      if (!variations) return false;
      if (selectedVariationTypes.length === 0) return false;

      return selectedVariationTypes.every((type) => {
        const v = variations[type];
        if (!v) return false;
        ...
        const profitMargin = v.profitMargin;
        if (profitMargin === "" || profitMargin === null || profitMargin === undefined) return false;
    ...
    const areDetailsValid = selectedWarehouse.length > 0 && selectedWarehouse.every((warehouseName) => {
      if (ptype === "Single") return validateSingleWarehouse(warehouseName);
      if (ptype === "Variation") return validateVariationWarehouse(warehouseName);
      return false;
    });
  ...
  const handleSubmit = async (event) => {
    ...
    const formattedWarehouses = ptype === "Single"
  ...
  const handleCategoryLogoChange = async (e) => {
    ...
    try {
      ...
      setCategoryLogoPreview(originalPreviewUrl);
      ...
      setCategoryLogo(compressedFile);
      setError("");
    } catch (error) {
      console.error("Compression Error:", error);
  ...
  const handleBrandLogoChange = async (e) => {
    ...
    try {
      ...
      const originalPreviewUrl = URL.createObjectURL(file);
      setBrandLogoPreview(originalPreviewUrl);
      ...
      <div className="bg-white mt-[20px] w-full min-h-full rounded-2xl px-8 shadow-md justify-between">
        <form className="pb-10 justify-between" onSubmit={handleSubmit}>
          <div className="flex min-h-full flex-1 flex-col px-2 py-10 lg:px-12 justify-between">
            ...
            <div className="flex flex-col lg:flex-row lg:space-x-4 mt-4">
              ...
              <div className="flex flex-col lg:flex-row lg:space-x-8 w-full">
                ...
                <div className="flex-1 w-full mb-4 lg:mb-0">
                  <div className="mt-4">
                    <label className="block text-sm font-medium leading-6 text-gray-900 text-left mb-2">
                    ...
                    <div className="relative w-full">
                      ...
                      >
                        <input
                          ...
                          className="searchBox w-full pl-10 pr-12 py-[7.5px] border border-gray-300 rounded-md shadow-sm focus:border-transparent"
                          value={category}
                        />
                        ...
                        <button
                          ...
                          className="absolute inset-y-0 right-0 pr-2 flex items-center bg-teal-600 hover:bg-teal-700 rounded-r-md px-3 text-white"
                        >
                          <svg
                            className="h-5 w-5"
                            fill="currentColor"
                  ...
                  <div className="mt-4">
                    ...
                    <div className="relative w-full">
                      ...
                      >
                        ...
                        <button
                          type="button"
                          onClick={(e) => setAddBrandOpen(true)}
                          className="absolute inset-y-0 right-0 pr-2 flex items-center bg-teal-600 hover:bg-teal-700 rounded-r-md px-3 text-white"
                        >
                          <svg
                            className="h-5 w-5"
                  ...
                  <div className="mt-4">
                    ...
                    <div className="relative w-full">
                      ...
                      >
                        ...
                        <button
                          type="button"
                          onClick={(e) => setAddSupplierOpen(true)}
                          className="absolute inset-y-0 right-0 pr-2 flex items-center bg-teal-600 hover:bg-teal-700 rounded-r-md px-3 text-white"
                        >
                          <svg
                            className="h-5 w-5"
            ...
            <div className="flex flex-col lg:flex-row lg:space-x-4 mt-5">
              {/* Fifth Sub-Div ============================================================================== */}
              <div className="flex flex-col lg:flex-row items-end gap-8 w-1/2">
                {/* Note */}
                <div className="lg:w-[64%] w-full">
                  ...
                  <input
                    ...
                    className="mt-2 block w-full rounded-md border-0 py-3 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-400 focus:ring-2 focus:ring-gray-400 sm:text-sm"
                  />
                </div>
                ...
                <div className="lg:w-[30%] w-full">
                  ...
                  {/* Green Button - Shows "Add Image" or filename inside */}
                  <label
                    htmlFor="image"
                    className="inline-flex w-full justify-center items-center gap-2 rounded-md bg-[#16796E] px-4 py-3 text-sm font-semibold text-white hover:bg-[#1A5B63] cursor-pointer transition-colors"
                  >
            ...
            {/* Warehouse */}
            <div className="flex flex-col w-1/3 lg:flex-row lg:space-x-6 mt-5">
              {/* Warehouse */}
              <div className="flex-1">
                    ...
                    <div className="p-[15px] rounded-md">
                      <div className="flex space-x-4 mb-5">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="mt-5">
                            <label className={`mt-5 text-sm font-medium leading-6 text-gray-900 text-left`}>
                              Discount
                            </label>
                        ...
                        <div className="flex-1">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              handleVariationValueChange(warehouseName, type, "taxType", e.target.value)
                            }
