...
export const updateCurrency = async (e, selectedCurrencyId, editcurrencyName, editcurrencyCode, editcurrencySymbole, setEditCurrencyName, setEditCurrencyCode, setEditCurrencySymbole, setResponse, setIsPopupOpen, setError, navigate, setRefreshKey, setSelectedCurrencyId, setIsPopUpEdit) => {
    e.preventDefault();
    ...
    try {
        ...
        setError && setError(backendMessage);
    }
};
