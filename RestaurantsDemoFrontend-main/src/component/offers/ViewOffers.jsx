                        ...
                        <table className="min-w-full bg-white border border-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {combinedOffersData.map((off) => (
                                    <tr key={off._id}>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-left">{off.offerName}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-left"><p className='rounded-[5px] text-center p-[6px] bg-green-100 text-green-500'>{off.percentage} % </p></td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-left">{off.createdBy}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-left">{off.endDate}</td>
