                ...
                {permissionData.create_sale && (
                    <div>
                        <Link
                            ...
                            className="submit flex-none rounded-md px-4 py-2.5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 whitespace-nowrap text-center relative z-10"
                        >
                            Create Sale
                        </Link>
                    </div>
