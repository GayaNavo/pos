...
function CreateSaleReturnForSupplier() {
    ...
    const handleQtyChange = (
        ...
        // Handle empty or zero quantity
        if (newQty <= 0) {
            if (qtyChange < 0) {
                toast.error('Return quantity cannot be less than 0!', { autoClose: 2000 }, { className: "custom-toast" });
                return;
            }
            // Allow setting to 0, which will filter out the product
            updatedReturnQty[index] = 0;
