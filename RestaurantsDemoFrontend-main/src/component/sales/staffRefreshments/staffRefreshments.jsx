...
import { Box, CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, Button, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, TextField } from '@mui/material';
...
const StaffRefreshments = () => {
    ...
    return (
        <div className='product-page-container relative bg-white absolute top-[80px] min-h-[100vh] p-3 sm:p-5'>
