                ...
                <div className="flex items-center w-full sm:w-auto">
                    {permissionData.create_warehouse && (
                        <div className="w-full sm:w-auto">
                            <Link
                                to={'/createWarehouse'}
                                className="submit flex-none rounded-md px-3 py-2.5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 w-full sm:w-auto md:w-auto md:px-4 text-center block whitespace-nowrap"
                            >
                                Create Warehouse
                            </Link>
                        </div>
                    ...
                    <table className="min-w-full bg-white border border-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-3 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Country</th>
                                <th className="px-3 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Created on</th>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {searchedWarehouse.map((searchedWarehouse) => (
                                <tr key={searchedWarehouse._id}>
                                    <td className="px-3 md:px-6 py-4 text-left whitespace-nowrap text-sm text-gray-900">{searchedWarehouse.name}</td>
                                    <td className="px-3 md:px-6 py-4 text-left whitespace-nowrap text-sm text-gray-900">{searchedWarehouse.country}</td>
                                    <td className="px-3 md:px-6 py-4 text-left whitespace-nowrap text-sm text-gray-900">{new Date(searchedWarehouse.createdAt).toLocaleDateString()}</td>
                                    <td className="px-3 md:px-6 py-4 text-right whitespace-nowrap text-sm text-gray-900">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {warehouseData.map((warehouse) => (
                                <tr key={warehouse._id}>
                                    <td className="px-3 md:px-6 py-4 text-left whitespace-nowrap text-sm text-gray-900">{warehouse.name}</td>
                                    <td className="px-3 md:px-6 py-4 text-left whitespace-nowrap text-sm text-gray-900">{warehouse.country}</td>
                                    <td className="px-3 md:px-6 py-4 text-left whitespace-nowrap text-sm text-gray-900">{new Date(warehouse.createdAt).toLocaleDateString()}</td>
