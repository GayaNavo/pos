...
function ViewExpensesBody() {
    ...
    const calculateTotalExpenses = () => {
        return combinedProductData.reduce((total, expense) => {
        ...
        <div className='relative background-white absolute top-[80px] left-[18%] w-[82%] h-[100vh] p-5'>
            ...
            {!loading && !error && combinedProductData.length > 0 && (
                <div className="flex justify-center mb-4">
                    <div className="rounded-xl shadow-md p-4 w-full max-w-xs text-center text-white" style={{ background: 'linear-gradient(to bottom right, #35AF87, #2d9672)' }}>
                        ...
                        <div className="text-2xl font-bold mb-1">
                            {currency} {formatWithCustomCommas(calculateTotalExpenses().toFixed(2))}
                        </div>
