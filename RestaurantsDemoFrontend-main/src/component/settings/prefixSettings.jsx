...
function PrefixSettingsBody() {
    ...
    const fetchSettings = async () => {
        try {
            const { data } = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/getPrefixSettings`);
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="container mx-auto text-left">
                            <div className='mt-5 flex justify-start'>
                                <button className='submit text-white rounded-md px-3.5 py-2.5 mt-10' type='submit'>
                                    Save Settings
                                </button>
                            </div>
                        </div>
